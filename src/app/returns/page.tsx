      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-6 space-y-6 text-sm leading-relaxed text-gray-600">
          ...
          <section>
            ...
            <p>
              Once we receive and inspect the returned item, your refund will
              be processed within 5–7 business days. For orders paid online
              (UPI, cards, net banking or wallets via Razorpay), the refund
              goes back to the original payment method. For Cash on Delivery
              orders, the refund is issued via bank transfer or UPI to the
